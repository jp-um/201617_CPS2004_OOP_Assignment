 ...
 * 
 * Note that this class does <b>not</b>
 * determine the intelligence of the robot players
 * but simply implements the 'rules of engagement'.
 *
...
public abstract class TTTWarEngine {
	...
	/**
	 * The two players, one will be playing X
	 * and the other will be playing O.
	 * 
	 * Eventually it might be a good idea to
	 * have a list of players, instead of hardcoding
	 * two (this way we can pair teams up etc.)
	 */
	 ...
	 * 
	 * Please note that it does not matter which robot plays X and
	 * which plays O since the starting robot is determined randomly. 
	 * 
	 * @param robotX An instance of the first robot, may not be null.  This
	 * robot will play with X.
	 * @param robotO An instance of the second robot, may not be null  This
	 * robot will play with O.
	 */
	public TTTWarEngine(final TTTRobot robotX, 
						 final TTTRobot robotO) {
		super(); // implied
		// do some validation
		if (robotX == null) {
	...
	/**
	 * Plays the game (gives a turn each to the players to play)
	 * Should set a winner (at the end of the encounter if non draw game).
	 */
